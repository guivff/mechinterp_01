...
- Geometry L15 (raw ‖d‖ / floor / constancy): neutral p1 **3.488** / 0.435 / 0.274, p2 2.434 / 0.423 / 0.171; math p1 5.380 / 0.152 / 0.674, p2 5.251 / 0.402 / 0.468; math/neutral 1.54 / 2.16. **C is 16.6× A seed 0 on neutral text (3.488 vs 0.210) at position 1, at matched accuracy and identical data** (recomputed 2026-09-05, `tools/recompute_oneliners.md` row 22; the earlier "17×" is this number rounded). Against A seed 1 (0.155) the same C vector is **22.6×**, so the honest headline is a **range across A's two seeds, 16.6–22.6× at p1**, not a single factor. At position 2 it is 13.2× (2.434 vs 0.184). C itself is single-seed, so only A's side of the ratio has a range.
