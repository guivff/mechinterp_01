...
## Quick start
    ...
    python data/make_snippets.py --model Qwen/Qwen3.5-4B-Base
    # Train/validate D first; only after Gate 1:
    bash grpo/launch_arms.sh                            # arms A and B on 2 GPUs
    python readout/run_readouts.py --arm D --base Qwen/Qwen3.5-4B-Base --adapter runs/D_s0/final --layer <L>
